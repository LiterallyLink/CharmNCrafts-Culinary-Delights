...
public class SpringRollMedleyBlock extends Block {
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (newServings < 0) {
            ...
            // Not the last serving - give Spring Roll item
            ItemStack springRoll = new ItemStack(ModItems.SPRING_ROLL);
            if (!player.getInventory().insertStack(springRoll)) {
                player.dropItem(springRoll, false);
            }
